  ...
  return (
    <section className="mt-24 py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute bottom-10 right-10 w-40 h-40 bg-gradient-to-r from-pink-500/10 to-cyan-500/10 rounded-full blur-xl animate-pulse"
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <p className="text-gray-300 mb-12 max-w-xl mx-auto text-lg animate-fade-in">
          ...
          <span className="text-cyan-400 font-semibold">lightning-fast</span>{" "}
          delivery:
        </p>
        ...
        <div className="space-y-12 mb-16">
          ...
          <div className="sm:block overflow-x-auto">
            <div className="flex sm:grid sm:grid-cols-4 gap-4 sm:gap-6 animate-slide-in-left">
              {citiesRow1.map((city, index) => (
                <div key={index} className="min-w-[130px] sm:min-w-0">
                  <CityCard
                    city={city}
                    index={index}
                    direction="left"
          ...
          {/* Row 2 */}
          <div className="sm:block overflow-x-auto">
            <div className="flex sm:grid sm:grid-cols-4 gap-4 sm:gap-6 animate-slide-in-right">
        ...
        {checkResult && (
          <div
            className={`max-w-md mx-auto p-6 rounded-2xl backdrop-blur-sm border transition-all duration-500 animate-fade-in-up ${
            ...
            {checkResult.available ? (
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm mb-4">
                  Pincode:{" "}
                  <span className="text-green-400">{checkResult.pincode}</span>
                </p>
